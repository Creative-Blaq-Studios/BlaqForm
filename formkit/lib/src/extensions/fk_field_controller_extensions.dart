...
/// String convenience extensions on [FkFieldController<String>].
extension FkFieldControllerStringX on FkFieldController<String> {
...
/// Widget builder extension for any [FkFieldController].
extension FkFieldControllerWidgetX<T> on FkFieldController<T> {
  ...
  /// ```
  Widget watch(Widget Function(FkFieldController<T> controller) builder) {
...
extension FkFieldControllerSignatureX
    on FkFieldController<List<List<Offset>>> {
