...
/// A visual progress indicator for an [BfWizardController].
///
...
///
/// ```dart
/// BfWizardProgress(controller: wizardController)
/// ```
class BfWizardProgress extends StatelessWidget {
  /// Creates a wizard progress indicator.
  const BfWizardProgress({
    super.key,
  ...
  final BfWizardController controller;
