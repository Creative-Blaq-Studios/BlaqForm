...
/// A star rating field bound to [FkFieldController<double>].
///
...
/// )
/// ```
class FkRatingField extends StatefulWidget {
  ...
  final FkFieldController<double> controller;
  ...
  @override
  State<FkRatingField> createState() => _FkRatingFieldState();
}

class _FkRatingFieldState extends State<FkRatingField> {
  ...
  FkFieldController<double> get _controller => widget.controller;
  ...
  @override
  void didUpdateWidget(covariant FkRatingField oldWidget) {
