...
///
/// Bound to [FkFieldController<List<List<Offset>>>] where each inner list is a
...
/// )
/// ```
class FkSignatureField extends StatefulWidget {
  /// Creates a signature field bound to [controller].
  const FkSignatureField({
    super.key,
    required this.name,
  ...
  final FkFieldController<List<List<Offset>>> controller;
  ...
  @override
  State<FkSignatureField> createState() => _FkSignatureFieldState();
}

class _FkSignatureFieldState extends State<FkSignatureField> {
  ...
  FkFieldController<List<List<Offset>>> get _controller => widget.controller;
  ...
  @override
  void didUpdateWidget(covariant FkSignatureField oldWidget) {
