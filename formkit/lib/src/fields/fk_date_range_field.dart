...
/// A date range picker field bound to [FkFieldController<DateTimeRange>].
///
...
/// )
/// ```
class FkDateRangeField extends StatefulWidget {
  /// Creates a date range picker field bound to [controller].
  const FkDateRangeField({
    super.key,
    required this.name,
  ...
  final FkFieldController<DateTimeRange> controller;
  ...
  @override
  State<FkDateRangeField> createState() => _FkDateRangeFieldState();
}

class _FkDateRangeFieldState extends State<FkDateRangeField> {
  ...
  FkFieldController<DateTimeRange> get _controller => widget.controller;
  ...
  @override
  void didUpdateWidget(covariant FkDateRangeField oldWidget) {
