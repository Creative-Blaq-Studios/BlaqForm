...
/// A text input field that integrates with [FkFieldController<String>].
///
/// Wraps a standard [TextField] and keeps it in sync with the provided
/// [FkFieldController]. Validation errors are displayed automatically when
/// [shouldShowError] is `true` (i.e. the field has been touched or the form
/// has been submitted).
///
/// Use the convenience constructors [FkTextField.password] and
/// [FkTextField.email] for common field configurations.
...
class _FkTextFieldState extends State<FkTextField>
    with FkFieldMixin<FkTextField, String> {
  ...
  @override
  void didUpdateWidget(covariant FkTextField oldWidget) {
