...
///
/// Bound to [FkFieldController<double>]. The displayed text is automatically
...
/// )
/// ```
class FkCurrencyField extends StatefulWidget {
  /// Creates a currency field bound to [controller].
  const FkCurrencyField({
    super.key,
    required this.name,
  ...
  @override
  State<FkCurrencyField> createState() => _FkCurrencyFieldState();
}

class _FkCurrencyFieldState extends State<FkCurrencyField> {
  ...
  @override
  void didUpdateWidget(covariant FkCurrencyField oldWidget) {
