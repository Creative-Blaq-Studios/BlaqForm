...
/// A slider field bound to [FkFieldController<double>].
///
...
/// )
/// ```
class FkSliderField extends StatefulWidget {
  ...
  @override
  State<FkSliderField> createState() => _FkSliderFieldState();
}

class _FkSliderFieldState extends State<FkSliderField> {
  ...
  @override
  void didUpdateWidget(covariant FkSliderField oldWidget) {
