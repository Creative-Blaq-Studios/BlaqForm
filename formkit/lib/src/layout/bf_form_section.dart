...
///   collapsible: true,
///   children: [
///     BfTextField(name: 'firstName'),
///     BfTextField(name: 'lastName'),
///   ],
/// )
/// ```
class BfFormSection extends StatefulWidget {
  ...
  @override
  State<BfFormSection> createState() => _BfFormSectionState();
}

class _BfFormSectionState extends State<BfFormSection>
