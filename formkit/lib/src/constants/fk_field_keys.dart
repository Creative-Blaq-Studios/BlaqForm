...
/// FkFormBuilder(
///   fields: {
///     FkUserKeys.email: FkFieldConfig.email(label: 'Email'),
///     FkUserKeys.password: FkFieldConfig.password(label: 'Password'),
///   },
///   builder: (context, form) => Column(children: [
///     form.email(FkUserKeys.email),
///     form.password(FkUserKeys.password),
///   ]),
/// )
/// ```
library;
...
abstract class FkPreferenceKeys {
