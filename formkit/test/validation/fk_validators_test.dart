...
void main() {
  group('Fk.required()', () {
    final validator = Fk.required<String>();
  ...
  group('Fk.minLength()', () {
    final validator = Fk.minLength(5);
  ...
  group('Fk.maxLength()', () {
    final validator = Fk.maxLength(5);
  ...
  group('Fk.pattern()', () {
    final validator = Fk.pattern(RegExp(r'^[A-Z]'));
  ...
  group('Fk.between()', () {
    final validator = Fk.between(1, 10);
  ...
  group('Fk.after()', () {
    ...
    final validator = Fk.after(pivot);
  ...
  group('Fk.before()', () {
    final pivot = DateTime(2024, 6, 15);
    final validator = Fk.before(pivot);
  ...
  group('Fk.age()', () {
    ...
    test('skips null', () {
      expect(Fk.age(18).validate(null), isNull);
    });
  });

  group('Fk.equals()', () {
    final validator = Fk.equals<String>('yes');
  ...
  group('Fk.custom()', () {
    test('uses the callback to validate', () {
      final validator = Fk.custom<String>((value) {
        if (value != null && value.contains('bad')) {
          return const FkValidationResult('Contains bad word', code: 'custom');
        }
        return null;
      });
  ...
  group('Fk.matchFields()', () {
    final validator = Fk.matchFields<String>('password');
