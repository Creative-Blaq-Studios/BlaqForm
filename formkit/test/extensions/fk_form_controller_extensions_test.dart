...
void main() {
  group('FkFormControllerJsonX', () {
    test('toJson() returns field values as JSON map', () {
      // Given: a form with registered fields
      final form = FkFormController();
      final nameCtrl = FkFieldController<String>(initialValue: 'Alice');
      final ageCtrl = FkFieldController<int>(initialValue: 30);
    ...
    test('toJson() converts DateTime to ISO 8601 string', () {
      ...
      final form = FkFormController();
      final dateCtrl =
          FkFieldController<DateTime>(initialValue: DateTime(2025, 6, 15));
    ...
    test('toJson() passes through null, num, bool, String', () {
      ...
      final form = FkFormController();
      final nullCtrl = FkFieldController<String>();
      final numCtrl = FkFieldController<double>(initialValue: 3.14);
      final boolCtrl = FkFieldController<bool>(initialValue: true);
      final strCtrl = FkFieldController<String>(initialValue: 'text');
    ...
    test('toJson() converts unknown types to String via toString()', () {
      ...
      final form = FkFormController();
      final ctrl = FkFieldController<_CustomObject>(
    ...
    test('fromJson() populates registered fields', () {
      // Given: a form with registered fields
      final form = FkFormController();
      final nameCtrl = FkFieldController<String>();
      final ageCtrl = FkFieldController<dynamic>();
      form.register('name', nameCtrl);
      form.register('age', ageCtrl);
    ...
    test('fromJson() skips unregistered field names', () {
      ...
      final form = FkFormController();
      final nameCtrl = FkFieldController<String>(initialValue: 'original');
      form.register('name', nameCtrl);
