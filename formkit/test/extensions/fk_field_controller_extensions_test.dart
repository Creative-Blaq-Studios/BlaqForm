...
void main() {
  group('FkFieldControllerStringX', () {
    test('trimmed returns trimmed value', () {
      // Given: a string controller with whitespace-padded value
      final controller = FkFieldController<String>(initialValue: '  hello  ');
    ...
    test('wordCount returns correct count for multi-word string', () {
      ...
      final controller =
          FkFieldController<String>(initialValue: 'hello world foo');
    ...
    test('wordCount handles multiple spaces correctly', () {
      ...
      final controller =
          FkFieldController<String>(initialValue: '  one   two   three  ');
  ...
  group('FkFieldControllerWidgetX', () {
