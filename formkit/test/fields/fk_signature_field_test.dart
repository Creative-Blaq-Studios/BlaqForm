...
void main() {
  group('FkSignatureField', () {
    testWidgets('renders a canvas container', (tester) async {
      final controller = FkFieldController<List<List<Offset>>>();

      await tester.pumpWidget(buildTestForm(
        child: FkSignatureField(
          name: 'sig',
  ...
  group('FkSignatureField.toBase64()', () {
