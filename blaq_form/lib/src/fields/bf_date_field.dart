...
/// A date picker field bound to [BfFieldController<DateTime>].
///
...
/// )
/// ```
class BfDateField extends StatefulWidget {
  ...
  final BfFieldController<DateTime> controller;
  ...
  @override
  State<BfDateField> createState() => _BfDateFieldState();
}

class _BfDateFieldState extends State<BfDateField> {
  ...
  BfFieldController<DateTime> get _controller => widget.controller;
  ...
  @override
  void didUpdateWidget(covariant BfDateField oldWidget) {
