...
/// A chip-based multi-select field bound to [BfFieldController<List<T>>].
///
...
/// )
/// ```
class BfChipSelectField<T> extends StatefulWidget {
  /// Creates a chip-based multi-select field bound to [controller].
  const BfChipSelectField({
    super.key,
    required this.name,
  ...
  @override
  State<BfChipSelectField<T>> createState() => _BfChipSelectFieldState<T>();
}

class _BfChipSelectFieldState<T> extends State<BfChipSelectField<T>> {
  ...
  @override
  void didUpdateWidget(covariant BfChipSelectField<T> oldWidget) {
