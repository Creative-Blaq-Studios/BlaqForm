...
/// )
/// ```
class BfPhoneField extends StatefulWidget {
  ...
  @override
  State<BfPhoneField> createState() => _BfPhoneFieldState();
}

class _BfPhoneFieldState extends State<BfPhoneField> {
  ...
  @override
  void didUpdateWidget(covariant BfPhoneField oldWidget) {
