...
/// The concatenated digits are stored in the bound [BfFieldController<String>].
///
/// ```dart
/// BfOtpField(
///   name: 'otp',
...
/// )
/// ```
class BfOtpField extends StatefulWidget {
  ...
  @override
  State<BfOtpField> createState() => _BfOtpFieldState();
}

class _BfOtpFieldState extends State<BfOtpField> {
  ...
  @override
  void didUpdateWidget(covariant BfOtpField oldWidget) {
