...
/// Theme extension for customizing BlaqForm's appearance.
///
/// [BfFormTheme] integrates with Flutter's [ThemeExtension] system so that
/// all BlaqForm fields automatically pick up the configured styles.
///
...
class BfFormTheme extends ThemeExtension<BfFormTheme> {
  /// Creates a BlaqForm theme with the given styling properties.
  ///
  ...
  /// Default [InputDecoration] applied to all BlaqForm fields.
  ///
