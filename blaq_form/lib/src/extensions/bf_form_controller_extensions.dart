...
/// JSON serialization extensions on [BfFormController].
extension BfFormControllerJsonX on BfFormController {
...
/// Dirty tracking extensions on [BfFormController].
extension BfFormControllerDiffX on BfFormController {
  /// Returns a map containing only the fields whose values have changed
  /// from their initial values (i.e., fields where [BfFieldController.isDirty]
  /// is `true`).
  ///
