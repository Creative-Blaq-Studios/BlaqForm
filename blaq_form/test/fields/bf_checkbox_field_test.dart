...
void main() {
  group('BfCheckboxField', () {
    testWidgets('renders a CheckboxListTile', (tester) async {
      // Given: a bool field controller
      final controller = BfFieldController<bool>(initialValue: false);

      // When: we render an BfCheckboxField
      await tester.pumpWidget(
        buildTestForm(
          child: BfCheckboxField(
            name: 'agree',
    ...
    testWidgets('shows error when shouldShowError is true', (tester) async {
      ...
      final controller = BfFieldController<bool>(
        initialValue: false,
